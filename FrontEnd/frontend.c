...
void mostrarTitulo(int x, int y, int opcion, int idiomaElegido)
{
    ...
    else if (idiomaElegido == 2)
    {
        ...
        */
        ...
        if(opcion == 1)
        {
            gotoxy(x, y);     printf("  _______________________________________________");
            gotoxy(x, y + 1); printf("  |       _    _                                |");
            gotoxy(x, y + 2); printf("  |      | |  | |                               |");
            gotoxy(x, y + 3); printf("  |      | |__| | __ _ _ __   __ _ _ __ ___   __| _ _ __ ");
            gotoxy(x, y + 4); printf("  |      |  __  |/ _` | '_ \\ / _` | '_ ` _ \\ / _` | '_ \\");
            gotoxy(x, y + 5); printf("  |      | |  | | (_| | | | | (_| | | | | | | (_| | | | |");
            gotoxy(x, y + 6); printf("  |      |_|  |_|\\__,_|_| |_|\\__, |_| |_| |_|\\__,_|_| |_|");
            gotoxy(x, y + 7); printf("  |                            __/ |              | ");
            gotoxy(x, y + 8); printf("  |                           |___/             / | \\");
            gotoxy(x, y + 9); printf("  |                                              /\\ ");
            gotoxy(x, y + 10); printf("_|_________                   ");
